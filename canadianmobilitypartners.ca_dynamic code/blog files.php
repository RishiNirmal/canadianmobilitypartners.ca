...
<div class="pxp-content">
    <?php while (have_posts()) : the_post();
        ...
        <div class="pxp-blog-posts pxp-content-wrapper ">
			<div class="pxp-hero pxp-hero-small vh-50 mt-100">
<div class="pxp-hero-bg pxp-cover" style="background-image: url(https://canadianmobilitypartners.ca/wp-content/uploads/2022/07/banner-canada.jpg);"></div>
<div class="pxp-hero-opacity" style="background: rgba(0,0,0,0.4);"></div>
<div class="pxp-hero-caption pxp-hero-caption-bottom-left pxp-is-small container pxp-no-form">
<h1 class="text-white">CMP Blogs</h1>
<p class="pxp-text-light text-white mb-0">CMP enables small/medium sized immigration law practices to offer the same comprehensive global immigration services as larger competitors. This can be done without assigning your in-house resources or managing a global footprint. Schedule a free consultation with us now.</p>
</div>
</div>
            <div class="container">
                <div class="row">
